          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-4 w-4 text-export-primary focus:ring-export-primary border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <a href="/forgot-password" className="font-medium text-export-primary hover:text-export-primary hover:underline">
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-export-primary hover:bg-export-primary hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-export-primary disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {isLoading ? (
                  <div className="flex items-center">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-6 px-4 shadow sm:rounded-lg sm:px-10">
          <h3 className="text-lg font-semibold text-export-dark mb-4 text-center">
            Why MSMEs Choose AndhraExport
          </h3>
          <div className="space-y-3">
            <div className="flex items-center">
              <CheckCircle className="h-5 w-5 text-export-success mr-3" />
              <span className="text-sm text-gray-600">85% higher export success rate</span>
            </div>
            <div className="flex items-center">
              <CheckCircle className="h-5 w-5 text-export-success mr-3" />
              <span className="text-sm text-gray-600">30% reduction in export costs</span>
            </div>
            <div className="flex items-center">
              <CheckCircle className="h-5 w-5 text-export-success mr-3" />
              <span className="text-sm text-gray-600">70% faster documentation</span>
            </div>
            <div className="flex items-center">
              <CheckCircle className="h-5 w-5 text-export-success mr-3" />
